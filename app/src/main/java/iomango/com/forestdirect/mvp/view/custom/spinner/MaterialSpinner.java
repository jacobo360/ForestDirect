...
public class MaterialSpinner
    ...
    private CustomTypeface itemTypeface;
    ...
    private void initializeView() {
        ...
        itemTypeface = null;
        itemTextColor = -1;
        itemBackgroundColor = R.color.white;
        ...
        setItemBackgroundColor(R.color.white);
     ...
     */
    public void setItemTypeFace(CustomTypeface type) {
        itemTypeface = type;
    }
    ...
    public class PopupListItemAdapter
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.textView = (CustomTextView) convertView.findViewById(android.R.id.text1);
     ...
     */
    @Override
    public void setTypeFace(CustomTypeface type) {
    ...
    public static class Builder {
        ...
        protected CustomTypeface spinnerTypeface = null;
        ...
        protected CustomTypeface itemTypeface = null;
